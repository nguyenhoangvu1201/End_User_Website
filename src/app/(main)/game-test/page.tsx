...
import Loader from "@/components/ui/TruckLoader";
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-700 text-sm">
                Khám phá con đường sự nghiệp phù hợp với bạn
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="fixed inset-0 bg-black/10 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-8 w-full max-w-md text-center animate-pulse border-2 border-orange-400">
            ...
            <p className="text-gray-700 mb-6">
              Bạn đã hoàn thành bài kiểm tra định hướng nghề nghiệp. Kết quả của
              bạn đã được lưu lại.
            </p>
            <button
              onClick={() => {
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 bg-black/10 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-8 w-full max-w-md text-center border-2 border-orange-400">
            ...
            <p className="text-gray-700 mb-6">
              Chúng tôi sẽ liên hệ với bạn qua email và điện thoại để xác nhận lịch
      ...
      <footer className="bg-white border-t border-orange-200 mt-16">
        <div className="max-w-6xl mx-auto px-6 py-8 text-center">
          <p className="text-black">
            © 2025 FPT University - Hệ thống tư vấn tuyển sinh và định hướng ngành
            học
          </p>
        </div>
      </footer>
